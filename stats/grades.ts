...
export const RATING_QUANTIFIED: Record<keyof PlayerRatings, string> = {
  ...
  platoonBias: '+10 above 50 ≈ −2.5 effective contact and −2 effective power points vs. a same-handed pitcher (≈ −0.3% single, −0.4% HR).',
  ...
  stamina: '+10 above 50 ≈ ~5 more pitches before fatigue starts and a slower decline once it does. Tired arms lose strikes (effective control), MPH off the fastball, and let opponents barrel pitches more easily. Pitch-count limits stay fixed (95 normal, 70 if shaky).',
  ...
  glove: '+10 above 50 ≈ −0.9% per-chance error rate. On hot smashes (>95 mph EV) low gloves take an additional tough-hop penalty; elite gloves stay near the floor (~0.2%).',
  ...
  speed: '+10 above 50 ≈ +0.6% triple rate, +0.6% single rate (legging out grounders, beating throws on bloops), and ~+1.5% chance to convert a routine grounder into an infield single. Outfield extra-base modeling lands later.',
