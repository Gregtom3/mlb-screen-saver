...
Last refreshed: 2026-06-10 (living-league pass).
...
|--------------|-------|--------|--------------------------------|
| render       | 22    | 7,616  | **search only** — never full   |
| sim          | 16    | 3,993  | grep first                     |
| ui           | 12    | 2,860  | grep first                     |
| app          |  7    | 2,378  | grep first — `main.ts` is 1,401 |
| stats        | 13    | 2,206  | grep first                     |
| audio        |  9    | 2,003  | ok to read whole               |
| season       | 11    | 1,598  | ok to read whole               |
| content      |  7    | 1,192  | ok to read whole               |
| ambience     |  7    | 1,140  | ok to read whole               |
| world        |  3    |   431  | read whole                     |
| projections  |  4    |   387  | read whole                     |
| director     |  1    |   114  | read whole                     |
