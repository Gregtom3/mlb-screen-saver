...
|--------------|-------|--------|--------------------------------|
| render       | 20    | 7,280  | **search only** — never full   |
| sim          | 13    | 2,863  | grep first                     |
| ui           | 11    | 2,727  | grep first                     |
| stats        | 13    | 2,150  | grep first                     |
| audio        |  9    | 1,974  | ok to read whole               |
| app          |  7    | 1,698  | ok, but `main.ts` is 721       |
| content      |  7    | 1,144  | ok to read whole               |
| ambience     |  7    | 1,129  | ok to read whole               |
